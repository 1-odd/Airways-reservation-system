...
public class Ticket {
    ...
    public void printTicketToPdf() {
        try {
            ...
            contents.newLine();
            contents.showText("Passport Number: " + " " + passenger.passportNo);
            contents.newLine();
